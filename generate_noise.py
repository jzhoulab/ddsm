...
from ddsm_lib import noise_factory
...
def parse_args():
    ...
    parser.add_argument("--steps_per_tick", type=int,
                        help="Number of steps per time tick. Tick is (<max_time> - <min_time>) / num_time_steps "
                             "(default = 200)", # +
                        default=200)
...
if __name__ == '__main__':
    ...
    filename = f'steps{args.num_time_steps}.cat{args.num_cat}{str_speed}.time{args.min_time}-{args.max_time}.' \
